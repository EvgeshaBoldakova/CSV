...
function processCSV(cities) {
    ...
    return (text) => {
        const regex = new RegExp(`(^|\\s)(${Object.keys(newCities).join('|')})(
\\s|[., ;?!]|$)`, 'g');
...
console.log(processCSV(cities)(prompt
("Enter text", "Наша столиця - Київ! Харків - велике місто, як і Дніпро. А як щодо Запоріжжя?")))